...
export default function RootLayout({
  ...
  return (
    ...
    <html lang="en" suppressHydrationWarning>
      <body
        className={`${outfit.variable} ${jetBrainsMono.variable} antialiased bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-50 selection:bg-[#7D87FF] selection:text-white`}
      >
        <ThemeProvider
          attribute="class"
          defaultTheme="system"
